...
const AdminRightCompartment = () => {
  ...
  const handleSearch = async () => {
    if (filter === 'dateRange') {
      ...
      if (fromDate > toDate) {
        alert('Please enter a valid date range: "From" date should be earlier than or equal to the "To" date.');
        setStartDate('');
        setEndDate('');
        return; 
      }
      ...
      <div className="search-area">
        {filter === 'username' ? (
          ...
          <div className="dateRange-container">
            ...
            <label className="dateRange-item">From</label>
            <input
              type="date"
...
<div className="select-date">
            <label className="dateRange-item">To</label>
            <input
              type="date"
              className="date-field"
              value={endDate}
